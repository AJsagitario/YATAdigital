...
public class LibrariesForLibsInPluginsBlock extends AbstractExternalDependencyFactory {
    ...
    public static class AndroidxComposeLibraryAccessors extends SubDependencyFactory {
        private final AndroidxComposeIconsLibraryAccessors laccForAndroidxComposeIconsLibraryAccessors = new AndroidxComposeIconsLibraryAccessors(owner);
        ...
        /**
         * Group of libraries at <b>androidx.compose.icons</b>
         *
         * @deprecated Will be removed in Gradle 9.0.
         */
        @Deprecated
        public AndroidxComposeIconsLibraryAccessors getIcons() {
            org.gradle.internal.deprecation.DeprecationLogger.deprecateBehaviour("Accessing libraries or bundles from version catalogs in the plugins block.").withAdvice("Only use versions or plugins from catalogs in the plugins block.").willBeRemovedInGradle9().withUpgradeGuideSection(8, "kotlin_dsl_deprecated_catalogs_plugins_block").nagUser();
            return laccForAndroidxComposeIconsLibraryAccessors;
        }
     ...
     */
    @Deprecated
    public static class AndroidxComposeIconsLibraryAccessors extends SubDependencyFactory {

        public AndroidxComposeIconsLibraryAccessors(AbstractExternalDependencyFactory owner) { super(owner); }
        ...
        public Provider<MinimalExternalModuleDependency> getExtended() {
            org.gradle.internal.deprecation.DeprecationLogger.deprecateBehaviour("Accessing libraries or bundles from version catalogs in the plugins block.").withAdvice("Only use versions or plugins from catalogs in the plugins block.").willBeRemovedInGradle9().withUpgradeGuideSection(8, "kotlin_dsl_deprecated_catalogs_plugins_block").nagUser();
            return create("androidx.compose.icons.extended");
        }
    ...
    public static class DesugarLibraryAccessors extends SubDependencyFactory {
         ...
         * with version reference <b>desugar.jdk</b>
         * <p>
         * This dependency was declared in catalog libs.versions.toml
         *
         * @deprecated Will be removed in Gradle 9.0.
    ...
    public static class DesugarVersionAccessors extends VersionFactory  {
        ...
        /**
         * Version alias <b>desugar.jdk</b> with value <b>2.1.2</b>
         * <p>
         * If the version is a rich version and cannot be represented as a
         * single version string, an empty string is returned.
         * <p>
         * This version was declared in catalog libs.versions.toml
         */
        public Provider<String> getJdk() { return getVersion("desugar.jdk"); }
